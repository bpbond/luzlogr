...
## Installing
To install this package, use R's `install.packages()` function, or the "Packages" pane in [RStudio](https://www.rstudio.com/products/RStudio/). To install the latest, developmental version of this package from GitHub:
