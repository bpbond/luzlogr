...
By default individual lines are prefixed with a timestamp, and end with a carriage return, and the entire log starts with an open message and ends with a close one.
